...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full bg-slate-50/50">
      {/* Executive Hero Slideshow Section - Brand Green #6cb166 */}
      <section className="relative w-full overflow-hidden bg-[#6cb166]">
              ...
              return (
                <CarouselItem key={index}>
                  <div className="relative h-[620px] md:h-[680px] w-full flex items-center">
                    {/* Background Image & Green Brand Gradient Overlay */}
                    <div className="absolute inset-0 z-0">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-r from-[#4d8748] via-[#5aa054]/90 to-transparent" />
                      <div className="absolute inset-0 bg-gradient-to-t from-[#3b66b0]/60 via-transparent to-[#4d8748]/30" />
                    </div>

                    {/* Content Container */}
                    <div className="container mx-auto px-4 z-10 text-white">
                      <div className="max-w-3xl space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        <div className="inline-flex items-center gap-2 bg-white/20 border border-white/30 backdrop-blur-md px-3.5 py-1.5 rounded-full text-white font-headline font-bold text-xs tracking-wide">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-headline font-extrabold leading-[1.15] text-white tracking-tight">
                          {slide.title}<span className="text-white underline underline-offset-8 decoration-white/40">{slide.titleHighlight}</span>
                        </h1>
      ...
      {/* Institutional Partner Bar - Brand Blue #3b66b0 */}
      <section className="py-6 bg-[#3b66b0] border-b border-white/10 text-white text-xs font-headline font-bold">
      ...
      {/* Quick Impact Stats - Brand Green #6cb166 */}
      <section className="py-16 bg-[#6cb166] text-white relative shadow-inner">
        <div className="container mx-auto px-4">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Service Card 1 */}
            <div className="group p-8 rounded-2xl border border-slate-200 bg-slate-50/50 hover:bg-white hover:shadow-xl hover:border-[#6cb166]/50 transition-all duration-300 flex flex-col">
            ...
            {/* Service Card 2 */}
            <div className="group p-8 rounded-2xl border border-slate-200 bg-slate-50/50 hover:bg-white hover:shadow-xl hover:border-[#3b66b0]/50 transition-all duration-300 flex flex-col">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2 relative h-[480px] rounded-3xl overflow-hidden shadow-2xl border border-slate-200">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#3b66b0]/90 via-transparent to-transparent flex items-end p-8">
      ...
      {/* Corporate Call to Action - Brand Green #6cb166 */}
      <section className="py-20 bg-[#6cb166] text-white relative overflow-hidden">
