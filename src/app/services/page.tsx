...
import { ShieldCheck, BarChart3, BookOpen, HardHat, Droplets, CheckCircle, ArrowRight } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {services.map((service, idx) => (
            <Card key={idx} className="flex flex-col border border-slate-200 hover:border-[#6cb166]/50 hover:shadow-xl transition-all duration-300 rounded-2xl bg-white overflow-hidden">
              <CardHeader className="p-8 pb-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-wider bg-[#3b66b0] text-white px-2.5 py-1 rounded-full">
                    {service.badge}
                  </span>
                </div>
              ...
              <CardContent className="p-8 pt-4 mt-auto">
                <Button asChild className="w-full bg-[#3b66b0] hover:bg-[#2b4c85] text-white font-headline text-xs font-bold py-5 shadow-sm transition-colors">
        ...
        {/* Member Support Services - Brand Green #6cb166 */}
        <div className="bg-[#6cb166] rounded-3xl p-8 md:p-12 text-white shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <ul className="space-y-3.5 pt-2">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3 font-body text-sm font-semibold text-white">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 text-center">
                <HardHat className="w-8 h-8 text-white mx-auto mb-3" />
                <h4 className="font-headline font-bold text-sm text-white">Field Operations</h4>
                <p className="text-[11px] text-white/80 mt-1 font-body">Safety & Equipment</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 text-center">
                ...
                <p className="text-[11px] text-white/80 mt-1 font-body">Public Protection</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 text-center">
                ...
                <p className="text-[11px] text-white/80 mt-1 font-body">National Verification</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 text-center">
                <BarChart3 className="w-8 h-8 text-white mx-auto mb-3" />
                <h4 className="font-headline font-bold text-sm text-white">Reporting</h4>
                <p className="text-[11px] text-white/80 mt-1 font-body">District Analytics</p>
              </div>
            </div>
          </div>
        </div>
