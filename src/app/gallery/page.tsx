      ...
      <div className="container mx-auto px-4 max-w-6xl space-y-12">
        <div className="max-w-3xl space-y-4">
          ...
          <p className="text-slate-600 font-body text-base md:text-lg leading-relaxed">
            Visual record of ASSSERVA field projects, facility inspections, capacity building workshops, and community sanitation outreach across Rwanda.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {gallery.map((img, idx) => (
            <div key={img.id || idx} className="relative group overflow-hidden rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 bg-[#6cb166] h-72 border border-slate-200">
              {img.imageUrl && (
                <Image
                  src={img.imageUrl}
                  alt={img.description}
        ...
        <div className="p-10 bg-white border border-slate-200 rounded-3xl text-center shadow-md max-w-3xl mx-auto space-y-3">
